...
path = "C:/Users/mbr19/OneDrive/Escritorio/Python/Trabajos/Segunda practica 22 de agosto/"
...
class regresion:
 ...
 def trainning_model(self, X, y):
    ...
    Z_1, X_train_Z = self.preprocessing_Z(self,X_train)
